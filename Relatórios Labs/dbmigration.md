...
> 📉 **Right-sizing :** Como o EC2 não processa mais as queries do banco de dados, ele terá sobra de CPU e Memória. Profissionalmente, o próximo passo seria fazer o *downsize* (mudar de uma instância t3.medium para t3.micro, por exemplo) para economizar dinheiro.
